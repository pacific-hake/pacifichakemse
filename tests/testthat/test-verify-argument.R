...
test_that("verify_argument() - Test correct input", {
  ...
  expect_true(verify_argument(1:2, chk_class = c("numeric", "integer"), chk_len = 2))
  expect_true(verify_argument(c(1, 2), chk_class = c("numeric", "integer"), chk_len = 2))
})
...
test_that("verify_argument() - Test incorrect input", {
  ...
  expect_error(verify_argument(1:2, chk_class = "numeric", chk_len = 2))
  expect_error(verify_argument(c(1, 2), chk_class = "integer", chk_len = 2))
})