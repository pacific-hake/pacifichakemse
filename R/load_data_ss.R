#' Load the hake data (TODO: Improve docs on this function)
#'
#' @param mod SS3 file
#' @param sum_zero flag on whether 'main' recruitment deviations should sum to zero
#'
#' @return A list of parameters, input parameters, catch, selectivity
#' @export
