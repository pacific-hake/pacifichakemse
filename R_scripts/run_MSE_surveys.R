...
library(r4ss)
mod <- r4ss::SS_output(system.file("SS32018"), printstats=FALSE, verbose = FALSE) # Read the true selectivity
...
# # # #
save(ls.save,file = 'results/Survey/MSE_Real_Survey1.Rdata')
...
# # # #
save(ls.save,file = 'results/Survey/MSE_Real_Survey2.Rdata')
...
# # # #
save(ls.save,file = 'results/Survey/MSE_Real_Survey3.Rdata')
